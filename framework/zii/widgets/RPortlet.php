...
/**
 * RPortlet is the base class for portlet widgets.
 *
 ...
 *
 * <pre>
 * <?php $this->beginWidget('zii.widgets.RPortlet'); ?>
 *     ...insert content here...
 * <?php $this->endWidget(); ?>
 * </pre>
 *
 ...
 * @since 1.1
 */
class RPortlet extends CWidget
{
	/**
	 ...
	 */
	public $decorationCssClass='block_Afstemning'; //'portlet-decoration';
	/**
	...
	protected function renderDecoration()
	{
		if($this->title!==null)
		{
			echo "<section class=\"{$this->decorationCssClass}\">\n";
			echo "<span>{$this->title}</span>\n";
			echo "</section>\n";
			echo "<section class=\"block_Afstemningright\"></section>";
