  ...
  <section>
	...
	}else
	{
		...
		if(Yii::app()->language == 'en')
			$language = 'uk';
		//array('/user/profile/'.$profilename)
	 echo CHtml::link('<span></span>',Yii::app()->baseurl.'/'.$language.'/user/profile/'.$profilename,array('title'=>UserModule::t('My profile'),'class'=>'tooltipster')); 
