...
class DzRaty extends CInputWidget
{
	...
	public function init()
	{
		...
		$this->_defaultOptions = array(
			...
			'hints' => array(
				Yii::t('DzRaty.DzRaty','I wish you luck'),
				Yii::t('DzRaty.DzRaty','Not really'),
				Yii::t('DzRaty.DzRaty','Hmmm..'),
				Yii::t('DzRaty.DzRaty','Now we´re talking!'),
				Yii::t('DzRaty.DzRaty','Marry me!!')
			),
