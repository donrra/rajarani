...
class Gallery extends CActiveRecord
{
    ...
    public function relations()
    {
       ...
       /*return array(
		  ...
		  return array(
            'galleryPhotosbyuser' => array(self::HAS_MANY, 'GalleryPhoto', 'gallery_id', 'condition' => 'user_id = :user_id','params' => array(':user_id'=>Yii::app()->user->id)),
			 'galleryPhotos' => array(self::HAS_MANY, 'GalleryPhoto', 'gallery_id', 'order' => '`rank` asc'),
        );
    }
    ...
    //    foreach ($this->galleryPhotosbyuser as $photo) {
            $photo->delete();
        }
