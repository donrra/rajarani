...
class UserModule extends CWebModule
{
	...
	public $registrationUrl = array("/backend/user/registration");
	public $recoveryUrl = array("/backend/user/recovery/recovery");
	public $loginUrl = array("/backend/user/login");
	public $logoutUrl = array("/backend/user/logout");
	public $profileUrl = array("/backend/user/profile");
	public $returnUrl = array("/backend/user/profile");
	public $returnLogoutUrl = array("/backend/user/login");
	public $returnhomeUrl = array("/backend/user/home");
