...
<div id="content" class="safGrid"> 
  ...
  <div id="mainContent" class="col cs-10 centered">
   ...
   case "2":
	...
	?>
    <ul class="nav">
        <li><a href="#tab-6" <?php echo $step6;?>>Præsentation</a></li>
 ...
 <!-- TAB 1 STARTS HERE -->
	...
	$checkfields2=array('romance','aboutme');
	$checkfields3=array('eyescolor','hair','height','weight','tattoo','bodytype');
	$checkfields4=array('sports','smoke','entertainment','exercise','music','pets','politics','religion');
	//$checkfields5=array('havechildren');
...
// echo $form->checkBoxList($profile,$field->varname,Profile::range($field->range));
...
?>
            <div class="row buttons">
              ...
              <?php echo CHtml::submitButton($model->isNewRecord ? UserModule::t('Create') : UserModule::t('Save')); ?> </div>
          </fieldset>
          <?php $this->endWidget(); ?>
          </fieldset>
        </div>
...
<?php
	...
	?>            <div class="row"> <?php echo $form->labelEx($profile,$field->varname);
		...
		echo $form->dropDownList($profile,$field->varname,Profile::range($field->range));	//echo $form->dropDownList($profile,$field->varname,Profile::range($field->range));
					} elseif ($field->field_type=="TEXT") {
						echo $form->textArea($profile,$field->varname,array('rows'=>6, 'cols'=>50));
						} else {
							echo $form->textField($profile,$field->varname,array('size'=>60,'maxlength'=>(($field->field_size)?$field->field_size:255)));
...
<?php 
	...
	/**///	$profileFields=$profile->getFields();
		if ($profileFields6) {
			foreach($profileFields2 as $field) {
			?>
            <div class="row"> <?php echo $form->labelEx($profile,$field->varname);
