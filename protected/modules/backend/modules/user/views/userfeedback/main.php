...
'import'=>array(
	...
	'image'=>array(
		...
		// uncomment the following to enable URLs in path-format
		 'urlManager'=>array(
            ...
            'rules'=>array(
				...
				'user/profile/<id:\w\->'=>'user/profile/profile',
		...
		'db'=>array(
			'connectionString' => 'mysql:host=mysql5.gigahost.dk;dbname=norvida_rr1',
			'emulatePrepare' => true,
			'username' => 'norvida',
			'password' => 'QE73dse313',
			'charset' => 'utf8',
		...
		/*'dbadvert' => array(
            'connectionString' => 'mysql:host=mysql5.gigahost.dk;dbname=norvida_test',
            'emulatePrepare'   => true,
			'username'         => 'norvida',
            'password'         => 'QE73dse313',
            'charset'          => 'utf8',
