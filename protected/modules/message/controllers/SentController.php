...
class SentController extends Controller
{
	...
	public function actionSentview() {
		
		$this->layout='//layouts/subpage';
		$senderId = (int)Yii::app()->request->getParam('message_id');
		$sentMessage = Message::model()->findAllByAttributes(array('id'=>$senderId));
		
							
		$this->render(Yii::app()->getModule('message')->viewPath . '/sentview', array('sentMessage' => $sentMessage
		));
	}
