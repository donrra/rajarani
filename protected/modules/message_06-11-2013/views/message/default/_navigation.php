...
?>
            <aside class="buttons">
            <p><a  class="green bold" id="msginbox" href="<?php echo $inboxlink; ?>"><?php echo MessageModule::t("Inbox"); ?><?php if (Yii::app()->getModule('message')->getCountUnreadedMessages(Yii::app()->user->getId())): ?>
