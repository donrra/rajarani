...
class ProfileField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('title, match,optiontype, error_message, other_validator, default, widget', 'length', 'max'=>255),
			array('range, widgetparams', 'length', 'max'=>5000),
			array('id, varname, title, field_type, field_size, field_size_min, required, match, range,optiontype, error_message, other_validator, default, widget, widgetparams, position, visible', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'optiontype' => UserModule::t('Option Type'),
    ...
    public function search()
    {
	    ...
	    $criteria->compare('optiontype',$this->optiontype,true);
