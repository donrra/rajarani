                        ...
                        <ul class="msg_lists">
							...
							foreach($fav_list as $fav)
                            {
								if($fav->profile->avatar!=NULL)
									{
	    								 if($fav->profile->avatar=='user_avatar/thumb/default.jpg')
										   {
												if($fav->profile->gender=='Female')
                                ...
                                <li>
									...
									<div class="msg_block">
										...
										if(Yii::app()->language == 'en')
											$language = 'uk';
										echo CHtml::link($fav->username,Yii::app()->baseurl.'/'.$language.'/user/profile/'.$fav->username);
										//echo CHtml::link($fav->username,array('/user/profile/'.$fav->username)); ?></h4>
										<p class="msg">- -</p>
