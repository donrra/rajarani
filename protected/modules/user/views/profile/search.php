...
?>                            </div>
					...
					<img src="<?php echo $circularthumbimg; ?>" class="round_50" />
											...
											<p class="about_image">
												...
												echo CHtml::link($ind_user['searchuser']->username,Yii::app()->baseurl.'/'.$language.'/user/profile/'.$ind_user['searchuser']->username);
												
												// echo CHtml::link($ind_user['searchuser']->username,array('/user/profile/'.$ind_user['searchuser']->username)); ?></strong>
