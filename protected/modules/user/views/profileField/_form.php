...
<?php echo CHtml::beginForm(); ?>
    ...
    <div class="row optiontype">
		<?php echo CHtml::activeLabelEx($model,'optiontype'); ?>
		<?php echo CHtml::activeTextField($model,'optiontype',array('size'=>60,'maxlength'=>500)); ?>
		
		<p class="hint"><?php echo UserModule::t('(example: Radio OR Select OR Checkbox) .'); ?></p>
	</div>
