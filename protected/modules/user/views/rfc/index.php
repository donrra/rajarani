				...
				<div class="left_container">
					<div class="left_block equal" style="height: 808px;">
                        ...
                        <ul class="msg_lists categoryitems">
							...
							{
								if($friend['user']->profile->avatar=='user_avatar/thumb/default.jpg')
								   {
										if($friend['user']->profile->gender=='Female')
...
?>
                                ...
                                <li>
									...
									<div class="msg_block">
										...
										$language = Yii::app()->language;
												...
												echo CHtml::link($friend['user']->username,Yii::app()->baseurl.'/'.$language.'/user/profile/'.$friend['user']->username);
										//echo CHtml::link($friend['user']->username,array('/user/profile/'.$friend['user']->username)); ?></h4>
									...
									<div class="icons">
										<p class="first"></p>
										<p class="user_block" id="<?php echo $friend['id']; ?>">
                                       	  <a>Block</a>
                                        </p>
                        ...
                        <ul class="msg_lists categoryitems">
                         ...
                         <ul class="msg_lists categoryitems">
                            ...
                            <div class="favorite_blocked menuheader expandable">
                          	Blocked
                         </div>
                         <ul class="msg_lists categoryitems">
								<?php
                            foreach($block_list as $friend)
                            {
									if($friend['user']->profile->avatar!=NULL)
									{
										if($friend['user']->profile->avatar=='user_avatar/thumb/default.jpg')
                            ...
                            ?>
                                 <li>
									...
									<div class="icons">
										<p class="first"></p>
                                         <p class="user_unblock" id="<?php echo $friend['id']; ?>"><strong><a>Unblock</a></strong></p>
										<p><a class="newclose_ico remove_rfc" rel="<?php echo $friend['id']; ?>" href="javascript:void(0);"></a></p>
									</div>
									<div class="clear"></div>
								</li>
	 ...
	 $(document).ready(function(e) {
		 ...
		 $('.user_add').live('click',function()
		{
		 ...
		 $('.user_block').live('click',function()
		{
	  		var $userobj=$(this);
			var id = $userobj.attr('id');
				$.ajax({
					type : 'POST', 
					url: <?php echo "'".Yii::app()->createUrl('/user/rfc/blockrfcbyid')."'"; ?>,
					datatype: "json",
					data: { 'id':id},
					success: function(complete){
		...
		$('.user_unblock').live('click',function()
		{
	  		var $userobj=$(this);
			var id = $userobj.attr('id');
				$.ajax({
					type : 'POST', 
					url: <?php echo "'".Yii::app()->createUrl('/user/rfc/unblockrfcbyid')."'"; ?>,
					datatype: "json",
					data: { 'id':id},
					success: function(complete){
