...
<div class="container" id="page">
	...
	<div id="mainmenu">
		...
		array('label'=>'Users', 'url'=>array('/backend/user/admin'), 'visible'=>!Yii::app()->user->isGuest),
		array('label'=>'CMS', 'url'=>array('/backend/page'), 'visible'=>!Yii::app()->user->isGuest),
		array('label'=>'System Message', 'url'=>array('/backend/user/systemmails'), 'visible'=>!Yii::app()->user->isGuest),
		array('label'=>'FeedBack', 'url'=>array('/backend/user/userfeedback'), 'visible'=>!Yii::app()->user->isGuest),
		array('label'=>'Comment', 'url'=>array('/backend/user/comment'), 'visible'=>!Yii::app()->user->isGuest),
		array('label'=>'Poll', 'url'=>array('/backend/poll/poll/admin'), 'visible'=>!Yii::app()->user->isGuest),
		array('url'=>array('/backend/translation'),'label'=>'Text Translation','visible'=>!Yii::app()->user->isGuest),
